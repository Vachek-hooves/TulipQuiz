...
import {SoundPlay} from '../../components/ui/icons';
...
const AboutTulipsScreen = () => {
  ...
  const buttons = [
    {
      title: 'Tulip Types',
      screen: 'TulipsTypesScreen',
      color: ['#FF6B6B', '#FF8E53'],
    },
    {
      title: 'Tulip Care',
      screen: 'TulipsCaringScreen',
      color: ['#4ECDC4', '#45B7AF'],
    },
    {
      title: 'Tulip Festivals',
      screen: 'TulipFestivalsScreen',
      color: ['#FF69B4', '#FF1493'],
    },
  ];
      ...
      <ImageBackground
        ...
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <Text style={styles.subtitle}>
            Explore the world of these beautiful flowers
          </Text>
